<%@ page language="java" import="java.util.*,java.sql.*" contentType="text/html; charset=utf-8" %>
    <%request.setCharacterEncoding("utf-8");%>
        ...
        <% String title="羽毛球场预约" ; String msg="" ; String year="" ; String month="" ; String day="" ; int showTable=1;
            String connectString="jdbc:mysql://172.18.187.253:3306/boke19335016" + "?autoReconnect=true&useUnicode=true"
            + "&characterEncoding=UTF-8" ; StringBuilder table=new StringBuilder(""); if(request.getParameter("query")
            !=null){ year=request.getParameter("year"); month=request.getParameter("month");
            day=request.getParameter("day"); if(day.equals("31")){
            if(month.equals("04")||month.equals("06")||month.equals("09")||month.equals("11")){ msg="无效日期" ;
            showTable=0; } } if(month.equals("02")){ if(day.equals("29")||day.equals("30")||day.equals("31")){
            msg="无效日期" ; showTable=0; } } if(showTable==1){ try{ String
            s="select count(*) from booking where time = ? and type = 'badminton' and year = '" + year +"' and
            month='" + month +"' and day='" + day + "'";
            
		Class.forName(" com.mysql.jdbc.Driver"); Connection con=DriverManager.getConnection(connectString, "user" , "123" );
            PreparedStatement stmt=con.prepareStatement(s); table.append("<table border='1'>");
            table.append("<tr>
                <th>时间段</th>
                <th>剩余数量</th>
                <th>操作</th>
            ...
            String[] timearray ={"10001100", "11001200", "14001500", "15001600", "16001700", "17001800", "18001900",
            "19002000", "20002100"};
            String[] timearray2 ={"10:00 - 11:00", "11:00 - 12:00", "14:00 - 15:00", "15:00 - 16:00", "16:00 - 17:00",
            "17:00 - 18:00", "18:00 - 19:00", "19:00 - 20:00", "20:00 - 21:00"};

            for(int i=0;i<9;i++){ table.append("<tr>
                <td>"+timearray2[i]+"</td>");
                ...
                table.append("<td><a href='" + url + "'>点击预约</a> </td>
                </tr>");
                }
                else{
                table.append("<td id='full'> 位置已满 </td>
                </tr>");
                }
                }
                rs.close();
