...
<%
	...
	if(request.getParameter("query") != null){
        ...
        String s="select count(*) from booking where time = ? and type = 'table-tennis' and year = '" 
        ...
        String[] timearray ={"10:00 - 11:00", "11:00 - 12:00", "14:00 - 15:00", "15:00 - 16:00", "16:00 - 17:00", "17:00 - 18:00", "19:00 - 20:00", "20:00 - 21:00", "21:00 - 22:00"};
		...
		if(rs.next()) {
            ...
            if(numi>0){
                String url = "booking.jsp?type=table-tennis&time="+timearray[i]+"&year="+year+"&month="+month+"&day="+day;
    ...
    <div id="main">
        <div id="mainbody" style="height: 550px;">
            <div id="indexline" style="height: 550px; ">
                <h2 id="secondheader">乒 乓 球 场 预 约</h2>
                <form action="booking-table-tennis.jsp" method="post" name="f" id="inputbox">
                    <label> &nbsp; 预约日期: &nbsp; </label>
                    <select name="year">
