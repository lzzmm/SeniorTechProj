...
<%
	...
	if(request.getParameter("query") != null){
        ...
        String s="select count(*) from booking where time = ? and type = 'tennis' and year = '" 
		...
		if(rs.next()) {
            ...
            if(numi>0){
                String url = "booking.jsp?type=tennis&time="+timearray[i]+"&year="+year+"&month="+month+"&day="+day;
    ...
    <div id="main">
        <div id="mainbody" style="height: 550px;">
            <div id="indexline" style="height: 550px; ">
                <h2 id="secondheader">网 球 场 预 约</h2>
                <form action="booking-tennis.jsp" method="post" name="f" id="inputbox">
                    <label> &nbsp; 预约日期: &nbsp; </label>
                    <select name="year">
