<%@ page language="java" import="java.util.*,java.sql.*" contentType="text/html; charset=utf-8" %>
    <% request.setCharacterEncoding("utf-8"); String msg="" ; String id="" ; if(session.getAttribute("userid")==null) {
        // TODO: try auto login include file="autologin.jsp" response.sendRedirect("login.jsp"); } else {
        id=(String)session.getAttribute("userid"); } String
        connectString="jdbc:mysql://172.18.187.253:3306/boke19335016" + "?autoReconnect=true&useUnicode=true"
        + "&characterEncoding=UTF-8" ; if(id !=null) { try{ Class.forName("com.mysql.jdbc.Driver"); Connection
        con=DriverManager.getConnection(connectString, "user" , "123" ); PreparedStatement
        stmt=con.prepareStatement("select * from student where s_id=?"); stmt.setString(1, id); ResultSet
        rs=stmt.executeQuery(); if (rs.next()) { rstable.append("<br><text> 登录成功！</text><br>");
